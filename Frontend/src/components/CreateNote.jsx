    ...
    <div className='create-note-form'>
      <form onSubmit={props.onSubmitFunction}>
        <div className=' flex flex-col items-start m-4 gap-2'>
          ...
          <button className='text-white w-full p-4 rounded-2xl bg-zinc-800 hover:ring hover:outline-none hover:ring-zinc-700 ease-in-out' type="submit">Create</button>
        </div>
      </form>
    </div>
  )
